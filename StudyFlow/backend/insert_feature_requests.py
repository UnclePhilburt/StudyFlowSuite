"""
Script to insert feature request routes into app.py
Run this once to add the feature requests API to the backend
"""
...
# Feature request routes code to insert
ROUTES_CODE = '''
...
def insert_routes():
    """Insert feature request routes into app.py before if __name__ == "__main__" """
    ...
    if "# ============= FEATURE REQUESTS API =============" in content:
        print("Feature request routes already exist in app.py!")
        return False
    ...
    updated_content = content.replace(if_main_pattern, ROUTES_CODE + '\n' + if_main_pattern)

    # Write updated content back
    with open(app_py_path, 'w', encoding='utf-8') as f:
        f.write(updated_content)

    print("Successfully added feature request routes to app.py!")
    print("Routes added:")
    print("  - GET    /api/feature-requests")
    print("  - POST   /api/feature-requests")
    print("  - POST   /api/feature-requests/<id>/vote")
    print("  - PATCH  /api/feature-requests/<id>")
    print("  - PATCH  /api/admin/feature-requests/<id>")
    print("  - DELETE /api/feature-requests/<id>")
    return True
