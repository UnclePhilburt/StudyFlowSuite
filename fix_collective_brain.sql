-- Fix Collective Brain SQL Function
-- Run this in Supabase SQL Editor to fix the "users table does not exist" error

-- Drop and recreate the function with correct table name (user_profiles instead of users)
